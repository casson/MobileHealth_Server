...
public class RecordDAO extends HibernateDaoSupport {
	...
	public List findByRhr(Object rhr) {
		return findByProperty(RHR, rhr);
	}

	public List findByAhr(Object ahr) {
		return findByProperty(AHR, ahr);
	}

	public List findByRegular(Object regular) {
		return findByProperty(REGULAR, regular);
	}
